...
export const MyDetails = React.forwardRef<HTMLFormElement>(({ idPrefix = 'caddie_myDetails' }, ref) => {
  ...
  if(isAuthenticated) {
    if (typeof window !== 'undefined') {
      const profileData = window.sessionStorage.profileData ? JSON.parse(window.sessionStorage.profileData) : '';
      if(profileData){
        detailsForAuthUser.firstName =  profileData.firstname;
        detailsForAuthUser.lastName =  profileData.lastname;
        detailsForAuthUser.email =  profileData.email;
      }
    }
  }
