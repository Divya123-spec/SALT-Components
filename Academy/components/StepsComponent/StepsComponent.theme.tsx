...
type Props = {
  progressLineActive:string;
  progressLineInactive:string;
  backButton:string;
  buttonFont:string;
...
declare global {
  interface EXOComponentStyles {
    commerce_stepsComponent?: Partial<Props>;
  }
}
...
export default (props: EXOThemeProps): Props => ({
    ...
    */
    ...
    ...props.theme?.byComponent.commerce_stepsComponent,
    ...props.theme?.ballot?.stepsComponent
  });
