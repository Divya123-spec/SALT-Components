...
export const useGolfAcademySubmit = () => {
    const [submitAcademy, { data, loading, error }] = useMutation(SUBMIT_PRESS_AREA_REGISTRATION_MUTATION);

    return { submitAcademy, data, loading, error };
};
